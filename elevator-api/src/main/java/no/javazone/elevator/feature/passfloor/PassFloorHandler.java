 ...
 * controller, and no affordance -- see {@link PassFloorCommand}'s
...
public class PassFloorHandler {
    ...
    public PassFloorHandler(ElevatorAggregateStore store, CommandEffects effects) {
        this.store = store;
     ...
     */
    public List<DomainEvent> handle(PassFloorCommand command) {
