 ...
 * clear-obstruction. {@link CommandRefused} propagates unchanged (not
 * currently obstructed) for the controller to translate into a 409.
 */
@Component
public class ClearObstructionHandler {
    ...
    public ClearObstructionHandler(ElevatorAggregateStore store, CommandEffects effects) {
        this.store = store;
        this.effects = effects;
    }

    public List<DomainEvent> handle(ClearObstructionCommand command) {
