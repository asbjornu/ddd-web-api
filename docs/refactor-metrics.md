...
(`38ff03c`, the last commit before slice 0 --
full CRUD shape), `json-hypermedia` (`564861c`, an
...
`main` (`6996941`, current tip: no BFF,
...
|---|---|---|---|
| elevator-api `main` files / lines | 24 / 1043 | 125 / 5820 | 133 / 6598 |
...
| elevator-ui | 35 | 1518 | 2791 | 4 | 8 | 23 |
| elevator-auth | 1 | 1 | 0 | 0 | 1 | 0 |
| docs | 14 | 19134 | 435 | 13 | 1 | 0 |
| **whole repo** | **268** | **30897** | **5236** | | | |
...
|---|---|---|
| elevator-api | +8819/-1894 | +1479/-445 |
| elevator-ui | +995/-654 | +1513/-3127 |
| elevator-auth | +0/-0 | +1/-0 |
| docs | +4619/-435 | +14532/-17 |
...
| Wall-clock time | 29.8s | 27.9s | 30.3s |
| Avg per test | 633.1ms | 142.3ms | 143.6ms |
...
real difference: 4.4x lower per test on the after side, while running
...
3s -- 43.4ms/test on average, including the JVM's own
