...
(`4045fba`). Re-run this script any time either
...
| docs | 5 | 14075 | 435 | 4 | 1 | 0 |
| **whole repo** | **257** | **25783** | **5017** | | | |
...
| Wall-clock time | 27.6s | 29.2s |
| Avg per test | 587.9ms | 138.6ms |
...
2.7s -- 38.2ms/test on average, including the JVM's own
