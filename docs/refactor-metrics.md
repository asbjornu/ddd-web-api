...
(`212f5fb`). Re-run this script any time either
...
| Duplication among the BFF route handlers alone | 0% (0 clones) |
...
|---|---|---|---|---|---|---|
| elevator-api | 210 | 9900 | 1903 | 179 | 4 | 27 |
| elevator-ui | 34 | 1518 | 2585 | 4 | 8 | 22 |
| elevator-auth | 1 | 1 | 0 | 0 | 1 | 0 |
| docs | 4 | 5637 | 435 | 3 | 1 | 0 |
| **whole repo** | **256** | **17344** | **5017** | | | |
