...
(`75c6ec8`). Re-run this script any time either
...
| docs | 5 | 14479 | 435 | 4 | 1 | 0 |
| **whole repo** | **257** | **26187** | **5017** | | | |
...
(6 -> 4): the after spec's own comment says why --
...
| Wall-clock time | 27.9s | 28.4s |
| Avg per test | 593ms | 134.6ms |
...
2.7s -- 38ms/test on average, including the JVM's own
